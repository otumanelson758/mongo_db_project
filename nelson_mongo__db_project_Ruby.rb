...
### We download our dataset that we will be working with from below link and
### save the data in folder on desktop.
...
##### Question 1. Group by the sender
...
Type "it" for more
```
##### Question 2. List all the unique senders
...
Type "it" for more
```
##### Question 3. Count all the unique senders
...
[ { _id: 1, count: 1985 } ]
```
##### Question 4. Group by sender and count to find out which email address sent the most emails
...
##### Question 5. Rank the senders in order or emails sent
...
##### Question 6. Rank the senders in order or emails sent + emails received
...
[ },
  ...
  ```
##### Question 7. Create a timeline that shows the number of emails by day
...
#####Question  8. Create a filter that shows the number of emails by day, sent by people who had sent 10 or more emails 
...
```
### Intergrating Javascript on VSCode needs admin credentials-its being blocked with security malware.
